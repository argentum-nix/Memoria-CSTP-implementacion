...
int main(int argc, char const *argv[])
{
    if (argc < 9)
    {
        ...
        cout << "Try: ./CSTPSolver ./instances/ instance1 network heuristicFlag graspFlag graspWindow seed closenessParam qualityFunction" << '\n';
        return 0;
    }
    ...
    Solver solve(&cstp, stoi(argv[4]), stoi(argv[5]), stoi(argv[6]), stoi(argv[7]), stof(argv[8]), argv[9][0]);
    return 0;
}